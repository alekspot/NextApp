const getMapElementsData = (
  ...
  const bottomSpace =
    mapElementData.top + mapElementData.height - markerElementData.top - markerHeight;
  ...
  const rightSpace =
    mapElementData.left + mapElementData.width - markerElementData.left - markerWidth;
